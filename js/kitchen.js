...
function onPageLoad(){
    ...
    while (myNode.firstChild) {
        ...
        if(roomid == 'Ungrouped'){
            console.log('es ungroued ! ');
            document.getElementById("title").innerHTML = 'Ungrouped Devices';
            var img = document.getElementById("deviceicon");
            img.setAttribute("src", "Iconos/ungrouped2.png"); 
            document.getElementById("breadcrumbfinal").innerHTML = 'Ungrouped Devices';
            document.getElementById("addicon").style.display = "none";
            document.getElementById("title").setAttribute("onclick", "");
            document.getElementById("title").setAttribute("onmouseout", "");
            document.getElementById("title").setAttribute("onmouseover", "");
            loadUngrouped();
        }else{
    ...
    api.rooms.getRooms().done(function(data) {
        ...
        $.each(data, function(i, item){
            ...
            if(item.name == document.getElementById("title").innerHTML){
                document.getElementById("breadcrumbfinal").innerHTML = item.name;
                console.log(item.id);
...
function loadUngrouped(){

   
                api.devices.getAllDevices().done(function(data) {
                   $.each(data, function(j, item2){
                       if(item2.meta.replace("{","").replace("}","").split(',')[0] == 'Ungrouped'){
