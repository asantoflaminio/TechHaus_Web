  ...
  var rut_id = window.localStorage.getItem("routine_id");
    ...
    var no = 0;
        if(device == "--" || device == "" || device == null){
                ...
                document.getElementById("device-tag22222").innerHTML = "Device is required";
        ...
        if(action == "--" || action == "" || action == null){
                ...
                document.getElementById("action-tag22222").innerHTML = "Action is required";
                $('#add_task_popup').modal('show');
        }else{
                            ...
                            if(item2.id == rut_id){
                                ...
                                api.routines.updateRoutine(rut_id, item2.name, pp).done(function(data){
                                  onPageLoad();
                                    ...
                                    document.getElementById("action-tag22222").innerHTML = "Action*";
                                    document.getElementById("device-tag22222").innerHTML = "Device*";
                                    document.getElementById("device_input2").options[document.getElementById("device_input2").selectedIndex].text = "--";
                                    document.getElementById("action_input2").options[document.getElementById("action_input2").selectedIndex].text = "--";
...
function add_routine(event, name) {
    ...
    api.routines.getRoutines().done(function(data) {
        ...
        if(device == "--" || device == "" || device == null){
                ...
                document.getElementById("device-tag").innerHTML = "Device is required";
                $('#add_room_popup').modal('show');
        }else{
        ...
        if(action == "--" || action == "" || action == null){
                ...
                document.getElementById("action-tag").innerHTML = "Action is required";
                $('#add_room_popup').modal('show');
        }else{
               ...
               if(device == item1.name){
                   ...
                   api.routines.postRoutine(rut_name, pp).done(function(data){
                                  ...
                                  onPageLoad();
                                    ...
                                    document.getElementById("action-tag").innerHTML = "Action*";
                                    document.getElementById("device-tag").innerHTML = "Device*";
                                    document.getElementById("name-tag").innerHTML = "Name*";
                                    document.getElementById("device_input").options[document.getElementById("device_input").selectedIndex].text = "--";
                                    document.getElementById("action_input").options[document.getElementById("action_input").selectedIndex].text = "--";
...
function cancel_routine(event, routine) {
    document.getElementById("action-tag").innerHTML = "Action*";
    document.getElementById("device-tag").innerHTML = "Device*";
    document.getElementById("name-tag").innerHTML = "Name*";
    document.getElementById("device_input").options[document.getElementById("device_input").selectedIndex].text = "--";
...
function cancel_task(event, routine) {
    document.getElementById("action-tag22222").innerHTML = "Action*";
    document.getElementById("device-tag22222").innerHTML = "Device*";
    document.getElementById("device_input2").options[document.getElementById("device_input2").selectedIndex].text = "--";
    document.getElementById("action_input2").options[document.getElementById("action_input2").selectedIndex].text = "--";
